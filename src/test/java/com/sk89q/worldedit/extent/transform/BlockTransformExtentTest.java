...
public class BlockTransformExtentTest {
    ...
    public void setUp() throws Exception {
        ...
        ignored.add(BlockType.SPRUCE_FENCE_GATE); //idk
        ignored.add(BlockType.BIRCH_FENCE_GATE);
        ignored.add(BlockType.JUNGLE_FENCE_GATE);
        ignored.add(BlockType.ACACIA_FENCE_GATE);
        ignored.add(BlockType.DARK_OAK_FENCE_GATE);
