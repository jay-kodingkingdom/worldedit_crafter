...
import com.sk89q.worldedit.extent.world.CoordinatedFastModeExtent;
...
public class EditSession implements Extent {
    ...
    private @Nullable CoordinatedFastModeExtent fastModeExtent;
    ...
    EditSession(EventBus eventBus, World world, int maxBlocks, @Nullable BlockBag blockBag, EditSessionEvent event) {
        ...
        if (world != null) {
            ...
            extent = fastModeExtent = new CoordinatedFastModeExtent(world, false);
