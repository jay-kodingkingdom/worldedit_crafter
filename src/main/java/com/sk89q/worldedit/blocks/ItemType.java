...
public enum ItemType {
    ...
    DAYLIGHT_DETECTOR_INVERTED(BlockID.DAYLIGHT_DETECTOR_INVERTED,"Daylight Detector Inverted","daylightdetectorinverted","inverteddaylightdetector"),
    ...
    DOUBLE_RED_SANDSTONE_SLAB(BlockID.DOUBLE_RED_SANDSTONE_SLAB,"Double Red Sandstone Slab","doubleredstoneslab"),
    STONE_SLAB2(BlockID.RED_SANDSTONE_SLAB,"Red Sandstone Slab","redsandstoneslab"),
    ...
    PRISMARINE_CRYSTALS(ItemID.PRISMARINE_CRYSTALS, "Prismarine Crystals", "prismarinecrystals"),
    RABBIT(ItemID.RABBIT, "Rabbit","rabbit"),
    COOKED_RABBIT(ItemID.COOKED_RABBIT,"Cooked Rabbit", "cookedrabbit"),
    RABBIT_STEW(ItemID.RABBIT_STEW, "Rabbit Stem", "rabbitstem"),
    RABBIT_FOOT(ItemID.RABBIT_FOOT, "Rabbit Foot", "rabbitfoot"),
    RABBIT_HIDE(ItemID.RABBIT_HIDE, "Rabbit Hide", "rabbithide"),
    ...
    MUTTON(ItemID.MUTTON,"Mutton"),
    COOKED_MUTTON(ItemID.COOKED_MUTTON,"Cooked Mutton","cookedmutton"),
    BANNER(ItemID.BANNER,"Banner"),
    SPRUCE_DOOR_ITEM(ItemID.SPRUCE_DOOR_ITEM,"Spruce Door Item", "sprucedoor"),
    BIRCH_DOOR_ITEM(ItemID.BIRCH_DOOR_ITEM,"Birch Door Item", "birchdoor"),
    JUNGLE_DOOR_ITEM(ItemID.JUNGLE_DOOR_ITEM, "Jungle Door Item", "jungledoor"),
    ACACIA_DOOR_ITEM(ItemID.ACACIA_DOOR_ITEM, "Acacia Door Item", "acaciadoor"),
    DARK_OAK_DOOR_ITEM(ItemID.DARK_OAK_DOOR_ITEM, "Dark Oak Door Item" , "darkoakdoor"),
