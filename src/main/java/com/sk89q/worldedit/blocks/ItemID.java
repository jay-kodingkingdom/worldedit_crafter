...
public final class ItemID {
    ...
    public static final int SPRUCE_DOOR_ITEM = 427;
    public static final int BIRCH_DOOR_ITEM = 428;
    public static final int JUNGLE_DOOR_ITEM = 429;
    public static final int ACACIA_DOOR_ITEM = 430;
    public static final int DARK_OAK_DOOR_ITEM = 431;
